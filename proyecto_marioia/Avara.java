...
public class Avara {
    ...
    public void determinarCosto(Nodo nd) {

        if (nd.getEstado() == 0) {
            nd.setCosto(CalcularHeuristica(nd));
        }
        if (nd.getEstado() == 1) {
            nd.setCosto(1);
        }
